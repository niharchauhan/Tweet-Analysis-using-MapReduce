...
public class HistogramQues3 extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        String outputFilePath = "/Users/niharchauhan/Downloads/part-00000-ques3";
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(outputFilePath))) {
            ...
            primaryStage.setTitle("Hourly Count of Tweets with the Word Sleep");
