...
public class WordCountRunnerQues1 {
    public static void main(String[] args) throws IOException {
        // Create a JobConf object for configuring the MapReduce job
        JobConf conf = new JobConf(WordCountRunnerQues1.class);
        conf.setJobName("WordCountQues1");
        ...
        conf.setMapperClass(WordCountMapperQues1.class);

        // Set the Combiner class to be used during the Map phase
        conf.setCombinerClass(WordCountReducerQues1.class);

        // Set the Reducer class to be used in the job
        conf.setReducerClass(WordCountReducerQues1.class);
